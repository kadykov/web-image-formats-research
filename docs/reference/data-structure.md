...
**Generated by**: `scripts/encode_images.py` (as part of encoding studies with `resize` config)
...
- Images are generated on-demand when a study specifies `resize` in its config
...
**Generated by**: `scripts/encode_images.py`
...
**Generated by**: `scripts/measure_quality.py`
...
```bash
just run-study-clean avif-quality-sweep
```
